...
<body>
	<form action="/management/announcement" 
			method="get" name="announcementGO" autocomplete="off" >
		        ...
		        <c:forEach items="${type1List}" var="announceVo">
		            <tr>
		                <td class = "contentName">
		                    <a href="/management/announcementView?announcement_id=${announceVo.announcement_id}" id = "nameText">
		                        ${announceVo.title}
		                    </a>
		                </td>
